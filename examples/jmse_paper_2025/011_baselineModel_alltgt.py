...
from helpers import interpolateData, split_ts, plot_val
...
modelPath = os.path.join(filePath, "models", "baseline_model")
modelName = f"baseline_model_alltgt_n{n}_m{m}_e{e}"
...
# Plot the results
last_components = tgt_val.components
plot_val(tgt_val, backtest, last_components)
